...
public class BillingConsts {
    ...
    public static final String ACTION_CONFIRM_NOTIFICATION = "cx.ath.troja.droidippy.CONFIRM_NOTIFICATION";
    public static final String ACTION_GET_PURCHASE_INFORMATION = "cx.ath.troja.droidippy.GET_PURCHASE_INFORMATION";
    public static final String ACTION_RESTORE_TRANSACTIONS = "cx.ath.troja.droidippy.RESTORE_TRANSACTIONS";
